...
<template>
    ...
    <div v-if="selectedCity">
        ...
        <div class="client-menu-cart-panel__order-settings-section">

            <div class="client-menu-cart-panel__city-selecte">
            ...
            <div class="order-settings">
                ...
                <div v-if="deliveryAvailableInSelectedCity" class="order-settings__radio-button">
                    <input class="order-settings__radio-button__input" type="radio" :id="`${idDeliveryRadioBtn}`"
                        :value=ORDER_TYPE.delivery v-model="selectedOrderType">
                ...
                <div v-if="pickUpAvailableInSelectedCity" class="order-settings__radio-button">
                    <input class="order-settings__radio-button__input" type="radio" :id="`${idPickUpRadioBtn}`"
                        :value=ORDER_TYPE.pickUp v-model="selectedOrderType">
                ...
                <div v-if="restaurantAvailableInSelectedCity" class="order-settings__radio-button">
                    <input class="order-settings__radio-button__input" type="radio" :id="`${idInRestaurantRadioBtn}`"
                        :value=ORDER_TYPE.inRestaurant v-model="selectedOrderType">
                    <label class="order-settings__radio-button__label" :for="`${idInRestaurantRadioBtn}`">В
                        ресторане</label>
                </div>
        ...
        <div class="client-menu-cart-panel__products-section">

            <div class="client-menu-cart-panel__product-section" v-for="product in productsInCart">

                <img class="client-menu-cart-panel__product-img" :src="product.image_url" alt="">
                <div class="client-menu-cart-panel__product-title">{{ product.title }}</div>
                <button class="client-menu-cart-panel__product-btn-helpers" @click="removeProductFromCart(product)">
            ...
            <div v-if="selectedOrderType == ORDER_TYPE.delivery"
                class="client-menu-cart-panel__product-section client-menu-cart-panel__delivery-section">
                <i class="client-menu-cart-panel__icon-delivery fa-solid fa-truck"></i>
                <div class="client-menu-cart-panel__product-title">Доставка</div>
                <div class="client-menu-cart-panel__product-total">{{ deliveryPrice }}р</div>
            </div>
        ...
        <div class="client-menu-cart-panel__total-order-section">
            ...
            <div v-if="selectedOrderType == ORDER_TYPE.delivery" class="client-menu-cart-panel__preview-order-message">
                ...
                <div v-else-if="totalProductPrice >= selectedCity.order_value_for_free_delivery"
                    class="client-menu-cart-panel__text-free-delivery">
                    Бесплатная доставка!!!
                </div>
            </div>
