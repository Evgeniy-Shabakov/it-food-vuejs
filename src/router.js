...
const routes = [
   ...
   },
   {
      ...
      children: [
...

         {
            ...
            component: () => import('./components/admin/legal-documents/index.vue'),
            name: 'admin.legal-documents.index'
         },
         {
            path: 'legal-documents/create',
            component: () => import('./components/admin/legal-documents/create.vue'),
   ...
   {
      path: '/order-manager',
      component: () => import('./components/order-manager/layouts/default.vue'),
      name: 'order-manager.default-layout',
      beforeEnter: (to, from, next) => {
         if (authUser.value) {
            if (authUser.value.employee.hasAdminPanelAccess) next()
            else {
      ...
      children: [
         {
            path: '/order-manager',
            component: () => import('./components/order-manager/pages/index.vue'),
            name: 'order-manager.index'
         },
         {
            path: 'stop-list',
            component: () => import('./components/order-manager/pages/stop-list.vue'),
            name: 'order-manager.stop-list'
         },
      ],
   },
]
