         ...
         <section v-if="product.additional_ingredients.length > 0"
            ...
            <div v-for="additonalIngredient in userAdditionalIngredientsForPage"
               ...
               <div class="adding-additional-ingredients__additional-ingredients-item-image-and-title">
                  <img class="adding-additional-ingredients__item-image"
                       :class="additonalIngredient.ingredient.is_in_stop_list ? 'adding-additional-ingredients__item-image--stop-list' : ''"
               ...
               <div v-if="additonalIngredient.ingredient.is_in_stop_list"
                    class="adding-additional-ingredients__text-for-stop-list">
                  Будет позже
               </div>
...
.adding-additional-ingredients__item-image {
   width: 25px;
   aspect-ratio: 1/1;
}

.adding-additional-ingredients__item-image--stop-list {
   filter: grayscale(80%);
}
...
.adding-additional-ingredients__text-for-stop-list {
   font-size: 14px;
